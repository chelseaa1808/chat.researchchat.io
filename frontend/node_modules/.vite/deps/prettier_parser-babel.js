  ...
  "node_modules/prettier/plugins/babel.js"(exports, module) {
    (function(f) {
      ...
      var $s = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), zs = (a, t) => {
        for (var e in t)
          be(a, e, { get: t[e], enumerable: true });
      }, Et = (a, t, e, s) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let i of _s(t))
            !js.call(a, i) && i !== e && be(a, i, { get: () => t[i], enumerable: !(s = Rs(t, i)) || s.enumerable });
        return a;
      };
        ...
        var ue = class {
          ...
          declareName(t, e, s) {
            ...
            if (e & 8 || e & 16) {
              ...
              for (let r = this.scopeStack.length - 1; r >= 0 && (i = this.scopeStack[r], this.checkRedeclarationInScope(i, t, e, s), i.names.set(t, (i.names.get(t) || 0) | 1), this.maybeExportDefined(i, t), !(i.flags & 387)); --r)
                ;
        ...
        var We = class extends Je {
          ...
          finalizeComment(t) {
            ...
            if (t.leadingNode !== null || t.trailingNode !== null)
              t.leadingNode !== null && Gt(t.leadingNode, e), t.trailingNode !== null && wi(t.trailingNode, e);
            else {
...
`);
        ...
        function Qt(a, t, e, s, i, r) {
          ...
          if (n === 123) {
            if (++t, { code: o, pos: t } = Ge(a, t, e, s, a.indexOf("}", t) - t, true, i, r), ++t, o !== null && o > 1114111)
              if (i)
                r.invalidCodePoint(t, e, s);
              else
                return { code: null, pos: t };
          } else
            ({ code: o, pos: t } = Ge(a, t, e, s, 4, false, i, r));
          return { code: o, pos: t };
        }
        function le(a, t, e) {
        ...
        var vi = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), M = class {
          ...
          skipBlockComment(t) {
            ...
            for (this.state.pos = i + t.length, Ae.lastIndex = s + 2; Ae.test(this.input) && Ae.lastIndex <= i; )
              ++this.state.curLine, this.state.lineStart = Ae.lastIndex;
            if (this.isLookahead)
              return;
          ...
          readToken_numberSign() {
            ...
            if (e === 123 || e === 91 && this.hasPlugin("recordAndTuple")) {
              if (this.expectPlugin("recordAndTuple"), this.getPluginOption("recordAndTuple", "syntaxType") === "bar")
                throw this.raise(e === 123 ? p.RecordExpressionHashIncorrectStartSyntaxType : p.TupleExpressionHashIncorrectStartSyntaxType, this.state.curPosition());
              this.state.pos += 2, e === 123 ? this.finishToken(7) : this.finishToken(1);
            } else
              R(e) ? (++this.state.pos, this.finishToken(139, this.readWord1(e))) : e === 92 ? (++this.state.pos, this.finishToken(139, this.readWord1())) : this.finishOp(27, 1);
          }
          readToken_dot() {
          ...
          readRegexp() {
            ...
            for (; ; ++r) {
              if (r >= this.length)
                throw this.raise(p.UnterminatedRegExp, v(t, 1));
            ...
            for (; r < this.length; ) {
              ...
              if (vi.has(l))
                l === 118 ? o.includes("u") && this.raise(p.IncompatibleRegExpUVFlags, h()) : l === 117 && o.includes("v") && this.raise(p.IncompatibleRegExpUVFlags, h()), o.includes(c) && this.raise(p.DuplicateRegExpFlags, h());
              else if (Y(l) || l === 92)
        ...
        var ji = /\*?\s*@((?:no)?flow)\b/, $i = (a) => class extends a {
          ...
          flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
            ...
            for (s && this.match(6) ? (this.expect(6), l = 9, c = true) : (this.expect(5), l = 8, c = false), h.exact = c; !this.match(l); ) {
              ...
              if (this.eat(0))
                x != null && this.unexpected(x), this.eat(0) ? (w && this.unexpected(w.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, d))) : h.indexers.push(this.flowParseObjectTypeIndexer(N, d, w));
              else if (this.match(10) || this.match(47))
                x != null && this.unexpected(x), w && this.unexpected(w.loc.start), h.callProperties.push(this.flowParseObjectTypeCallProperty(N, d));
              else {
                let I = "init";
          ...
          parseExpressionStatement(e, s, i) {
            if (s.type === "Identifier") {
              if (s.name === "declare") {
                if (this.match(80) || E(this.state.type) || this.match(68) || this.match(74) || this.match(82))
            ...
            if ((i = n) != null && i.error || this.match(47)) {
              ...
              if (c.node && this.maybeUnwrapTypeCastExpression(c.node).type === "ArrowFunctionExpression") {
                if (!c.error && !c.aborted)
                  return c.node.async && this.raise(g.UnexpectedTypeParameterBeforeAsyncArrowFunction, l), c.node;
                u = c.node;
              }
              if ((o = n) != null && o.node)
        ...
        function G(a) {
          ...
          if (a.type === "JSXMemberExpression")
            return G(a.object) + "." + G(a.property);
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          updateContext(e) {
            ...
            if (i === 56 && e === 143)
              s.splice(-2, 2, C.j_cTag), this.state.canStartJSXElement = false;
            else if (i === 143)
              s.push(C.j_oTag);
            else if (i === 144) {
              let r = s[s.length - 1];
              ...
              this.state.canStartJSXElement = ai(i);
          }
        }, rt = class extends ue {
          constructor(...t) {
          ...
          parseMaybeDefault(t, e) {
            var s, i;
            if ((s = t) != null || (t = this.state.startLoc), e = (i = e) != null ? i : this.parseBindingAtom(), !this.eat(29))
              return e;
          ...
          checkLVal(t, e, s = 64, i = false, r = false, n = false) {
            ...
            if (Array.isArray(x))
              for (let S of x)
                S && this.checkLVal(S, d, s, i, r, f);
            else
              x && this.checkLVal(x, d, s, i, r, f);
          }
        ...
        var Hi = (a) => class extends a {
          ...
          tsParseModifier(e, s) {
            if (!E(this.state.type) && this.state.type !== 58 && this.state.type !== 75)
              return;
            let i = this.state.value;
            if (e.includes(i)) {
          ...
          tsParsePropertyOrMethodSignature(e, s) {
            ...
            if (this.match(10) || this.match(47)) {
              ...
              if (r.kind === "get")
                r[n].length > 0 && (this.raise(p.BadGetterArity, this.state.curPosition()), this.isThisParam(r[n][0]) && this.raise(y.AccessorCannotDeclareThisParameter, this.state.curPosition()));
              else if (r.kind === "set") {
                if (r[n].length !== 1)
          ...
          parseSubscript(e, s, i, r) {
            ...
            if (this.match(47) || this.match(51)) {
              ...
              if (o && this.unexpected(o, 10), h)
                return h.type === "TSInstantiationExpression" && (this.match(16) || this.match(18) && this.lookaheadCharCode() !== 40) && this.raise(y.InvalidPropertyAccessAfterInstantiationExpression, this.state.startLoc), h;
            }
            return super.parseSubscript(e, s, i, r);
          }
          parseNewCallee(e) {
          ...
          parseVarStatement(e, s, i = false) {
            ...
            for (let { id: o, init: h } of n.declarations)
              h && (s !== "const" || o.typeAnnotation ? this.raise(y.InitializerNotAllowedInAmbientContext, h) : Wi(h, this.hasPlugin("estree")) || this.raise(y.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, h));
            return n;
          }
          ...
          parseMaybeAssign(e, s) {
            ...
            if (!c && (Rt(!this.hasPlugin("jsx")), u = this.tryParse(() => super.parseMaybeAssign(e, s), l), !u.error))
              return u.node;
            if ((r = c) != null && r.node)
          ...
          tsParseAbstractDeclaration(e, s) {
            ...
            if (this.isContextual(129)) {
              if (!this.hasFollowingLineBreak())
                return e.abstract = true, this.raise(y.NonClassMethodPropertyHasAbstractModifer, e), this.tsParseInterfaceDeclaration(e);
            } else
          ...
          parseTypeOnlyImportExportSpecifier(e, s, i) {
            ...
            if (this.isContextual(93)) {
              ...
              if (this.isContextual(93)) {
                ...
                D(this.state.type) ? (c = false, h = s ? this.parseIdentifier() : this.parseModuleExportName()) : (l = true, o = d);
            } else
              D(this.state.type) && (l = true, s ? (o = this.parseIdentifier(true), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, true, true)) : o = this.parseModuleExportName());
        ...
        var Ut = _`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), Gi = (a) => class extends a {
          ...
          isExportDefaultSpecifier() {
            if (this.match(65)) {
              let e = this.nextTokenStart();
              if (this.isUnparsedContextual(e, "from") && this.input.startsWith(q(133), this.nextTokenStartSince(e + 4)))
                return true;
            }
        ...
        function Qi(a) {
          ...
          if (!a.has("deprecatedImportAssert") && a.has("importAttributes") && a.get("importAttributes").deprecatedAssertSyntax && a.set("deprecatedImportAssert", {}), a.has("recordAndTuple")) {
            ...
            if (e != null) {
              let s = ["hash", "bar"];
              if (!s.includes(e))
                throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + s.map((i) => `'${i}'`).join(", "));
            }
          }
        ...
        var is = { estree: ti, jsx: zi, flow: $i, typescript: Hi, v8intrinsic: Yi, placeholders: Gi }, Zi = Object.keys(is), ot = class extends nt {
          ...
          parseExprOp(t, e, s) {
            ...
            if (hi(i) && (this.prodParam.hasIn || !this.match(58))) {
              ...
              if (r > s) {
                ...
                if (h && (r = Ce(42)), this.next(), i === 39 && this.hasPlugin(["pipelineOperator", { proposal: "minimal" }]) && this.state.type === 96 && this.prodParam.hasAwait)
          ...
          parseMaybeUnary(t, e) {
            ...
            if (i) {
              ...
              if ((this.hasPlugin("v8intrinsic") ? Ve(h) : Ve(h) && !this.match(54)) && !this.isAmbiguousAwait())
          ...
          parseTopicReferenceThenEqualsSign(t, e) {
            ...
            if (s)
              return this.state.type = t, this.state.value = e, this.state.pos--, this.state.end--, this.state.endLoc = v(this.state.endLoc, -1), this.parseTopicReference(s);
            this.unexpected();
          }
          ...
          finishTopicReference(t, e, s, i) {
            if (this.testTopicReferenceConfiguration(s, e, i))
              return s === "hack" ? (this.topicReferenceIsAllowedInCurrentContext() || this.raise(p.PipeTopicUnbound, e), this.registerTopicReference(), this.finishNode(t, "TopicReference")) : (this.topicReferenceIsAllowedInCurrentContext() || this.raise(p.PrimaryTopicNotAllowed, e), this.registerTopicReference(), this.finishNode(t, "PipelinePrimaryTopicReference"));
          ...
          parseImportMetaProperty(t) {
            ...
            if (this.next(), this.isContextual(101))
              this.inModule || this.raise(p.ImportMetaOutsideModule, e), this.sawUnambiguousESM = true;
            else if (this.isContextual(105) || this.isContextual(97)) {
              let s = this.isContextual(105);
              if (this.expectPlugin(s ? "sourcePhaseImports" : "deferredImportEvaluation"), !(this.optionFlags & 256))
                throw this.raise(p.DynamicImportPhaseRequiresImportExpressions, this.state.startLoc, { phase: this.state.value });
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
          ...
          parseExprListItem(t, e, s) {
            let i;
            if (this.match(12))
              t || this.raise(p.UnexpectedToken, this.state.curPosition(), { unexpected: "," }), i = null;
        ...
        var ht = class extends ot {
            ...
            switch (s) {
              ...
              case 96:
                if (!this.state.containsEsc && this.startsAwaitUsing())
                  return this.recordAwaitIfAllowed() ? r || this.raise(p.UnexpectedLexicalDeclaration, i) : this.raise(p.AwaitUsingNotInAsyncContext, i), this.next(), this.parseVarStatement(i, "await using");
                break;
              case 107:
          ...
          parseClassMemberWithIsStatic(t, e, s, i) {
            ...
            if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
              ...
              this.isLineTerminator() ? S ? this.pushClassPrivateProperty(t, h) : this.pushClassProperty(t, o) : this.unexpected();
          }
          ...
          isExportDefaultSpecifier() {
            ...
            if (this.input.charCodeAt(e) === 44 || E(this.state.type) && s)
              return true;
            if (this.match(65) && s) {
          ...
          checkImportReflection(t) {
            ...
            if (t.phase === "source")
              s !== "ImportDefaultSpecifier" && this.raise(p.SourcePhaseImportRequiresDefault, e[0].loc.start);
            else if (t.phase === "defer")
              s !== "ImportNamespaceSpecifier" && this.raise(p.DeferImportRequiresNamespace, e[0].loc.start);
            else if (t.module) {
              var i;
          ...
          maybeParseImportAttributes(t) {
            ...
            if (this.match(76)) {
              ...
              this.isContextual(94) && !this.hasPrecedingLineBreak() ? (!this.hasPlugin("deprecatedImportAssert") && !this.hasPlugin("importAssertions") && this.raise(p.ImportAttributesUseAssert, this.state.startLoc), this.hasPlugin("importAssertions") || this.addExtra(t, "deprecatedAssertSyntax", true), this.next(), e = this.parseImportAttributes()) : e = [];
...
` || i === "\r" || i === "\u2028" || i === "\u2029")
      ...
      function pr(a, t) {
        let e = null, s = t;
        for (; s !== e; )
          e = s, s = rs(a, s), s = ns(a, s), s = hs(a, s), s = os(a, s);
        return s;
      }
      var ls = pr;
      function ur(a) {
        ...
        if (e === "babel") {
          ...
          a = Me(a, (r) => {
            ...
            if (r.type === "ParenthesizedExpression") {
              let { expression: n } = r;
              if (n.type === "TypeCastExpression")
                return n.range = [...r.range], n;
              let o = L(r);
              if (!i.has(o))
                return n.extra = { ...n.extra, parenthesized: true }, n;
            }
          });
        }
        if (a = Me(a, (i) => {
...
`;
      ...
      function Br(a) {
        ...
        if (t) {
          if (t = t.toLowerCase(), t.endsWith(".cjs") || t.endsWith(".cts"))
            return "script";
          if (t.endsWith(".mjs") || t.endsWith(".mts"))
            return "module";
        }
      }
      var Ss = Br;
      ...
      function ae(a) {
        switch (a.type) {
          ...
          case "ObjectProperty":
            if (a.computed)
              throw K(a.key, "Computed key");
            if (a.shorthand)
              throw K(a.key, "Shorthand property");
            a.key.type !== "Identifier" && ae(a.key), ae(a.value);
            return;
          case "UnaryExpression": {
            let { operator: t, argument: e } = a;
            if (t !== "+" && t !== "-")
              throw K(a, `Operator '${a.operator}'`);
          ...
          case "TemplateLiteral":
            if (ye(a.expressions))
              throw K(a.expressions[0], "'TemplateLiteral' with expression");
