...
var xu = (e, t, r, n) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let u of Bu(t))
      !_u.call(e, u) && u !== r && At(e, u, { get: () => t[u], enumerable: !(n = vu(t, u)) || n.enumerable });
  return e;
};
...
U.prototype = { diff: function(t, r) {
  ...
  function C() {
    for (var E = Math.max(m, -l); E <= Math.min(h, l); E += 2) {
      ...
      if (!$e || X && j.oldPos < b.oldPos ? g = o.addToPath(b, true, false, 0, u) : g = o.addToPath(j, false, true, 1, u), F = o.extractCommon(g, r, t, E, u), g.oldPos + 1 >= D && F + 1 >= a)
  ...
  for (var o = r.length, s = n.length, a = t.oldPos, D = a - u, l = 0; D + 1 < o && a + 1 < s && this.equals(n[a + 1], r[D + 1], i); )
    D++, a++, l++, i.oneChangePerToken && (t.lastComponent = { count: 1, previousComponent: t.lastComponent, added: false, removed: false });
...
function Ou(e, t) {
  ...
  u[0] = 0;
  for (var o = 1; o < n; o++) {
    for (t[o] == t[i] ? u[o] = u[i] : u[o] = i; i > 0 && t[o] != t[i]; )
      i = u[i];
    t[o] == t[i] && i++;
  }
  i = 0;
...
function xt(e, t, r, n, u) {
  ...
  if (e && e.toJSON && (e = e.toJSON()), _t(e) === "object" && e !== null) {
    ...
    var s = [], a;
    for (a in e)
      Object.prototype.hasOwnProperty.call(e, a) && s.push(a);
    for (s.sort(), i = 0; i < s.length; i += 1)
      a = s[i], o[a] = xt(e[a], t, r, n, a);
    t.pop(), r.pop();
  } else
    o = e;
  return o;
...
function Hu(e) {
  if (e.type === B && e.break || e.type === y && e.hard || e.type === _)
    return true;
}
function xr(e) {
...
function _r(e) {
  for (e = [...e]; e.length >= 2 && A(false, e, -2).type === y && A(false, e, -1).type === _; )
    e.length -= 2;
  if (e.length > 0) {
...
function Ze(e, t, r) {
  ...
  let n = e;
  if (t > 0) {
    for (let u = 0; u < Math.floor(t / r); ++u)
      n = le(n);
...
function Vr(e) {
  ...
  function u(i) {
    ...
    for (let s = 0; ; s++) {
      let a = o + (s > 0 ? ` #${s}` : "");
      if (!r.has(a))
        return r.add(a), t[i] = `Symbol.for(${JSON.stringify(a)})`;
    }
  }
}
  ...
  for (; r >= 0; ) {
    ...
    switch (p) {
      ...
      case N: {
        ...
        for (let c = f.length - 1; c >= d; c--)
          s.push({ mode: D, doc: f[c] });
        break;
      }
      case T:
      case k:
        ...
        switch (d) {
          ...
          case Y: {
            ...
            if (!c.break && et(F, o, m, h, r))
              ...
              o.push({ ind: f, mode: Y, doc: c.contents });
            break;
          }
        }
  ...
  each(t, ...r) {
    ...
    try {
      for (let o = 0; o < i.length; ++o)
        n.push(o, i[o]), t(this, o, i), n.length -= 2;
    } finally {
      n.length = u;
    }
  }
...
function on(e, t) {
  let { comments: r } = e;
  if (delete e.comments, !Ht(r) || !t.printer.canAttachComment)
    return;
  ...
  for (let [d, c] of f.entries()) {
    ...
    let b;
    if (o ? b = [c] : (F.enclosingNode = h, F.precedingNode = m, F.followingNode = C, b = [F, v, E, g, j]), ni(v, E, f, d))
...
function it({ plugins: e = [], showDeprecated: t = false } = {}) {
  ...
  for (let u of ci(Object.assign({}, ...e.map(({ options: i }) => i), fn)))
    !t && u.deprecated || (Array.isArray(u.choices) && (t || (u.choices = u.choices.filter((i) => !i.deprecated)), u.name === "parser" && (u.choices = [...u.choices, ...li(u.choices, r, e)])), u.pluginDefaults = Object.fromEntries(e.filter((i) => {
      var o;
...
function Gt(e, t) {
  ...
  for (; n > 0 && e.charCodeAt(~-n) === t.charCodeAt(~-u); )
    n--, u--;
  let i = 0;
  ...
  for (; p < u; )
    for (o = t.charCodeAt(i + p), a = p++, s = p, l = 0; l < n; l++)
      D = o === vn[l] ? a : a + 1, a = zt[l], s = zt[l] = a > s ? D > s ? s + 1 : D : D > a ? a + 1 : D;
  return s;
}
...
function mi(e, t) {
  ...
  for (let u of Fi)
    u in t && (n[u] = hi(t[u], r, x.prototype[u].length));
  return n;
}
var x = class {
  static create(t) {
...
function _n(e, t) {
  ...
  for (let n of e) {
    let u = n[t];
    if (r[u])
      throw new Error(`Duplicate ${t} ${JSON.stringify(u)}`);
    r[u] = n;
  }
  return r;
}
...
var ht = class {
  ...
  _applyNormalization(t, r) {
    ...
    for (let o of u) {
      ...
      for (let { from: d, to: c } of f.redirect)
        l({ value: d, redirectTo: c });
    }
    for (let o of i) {
      let s = t[o];
...
function yi(e, { isCLI: t, FlagSchema: r }) {
  ...
  for (let u of e)
    n.push(Ai(u, { isCLI: t, optionInfos: e, FlagSchema: r })), u.alias && t && n.push(Dt.create({ name: u.alias, sourceName: u.name }));
  return n;
}
...
async function He(e, t) {
  ...
  if (ln(t), t.nodeAfterCursor && !t.nodeBeforeCursor)
    return [Z, o];
...
function ki(e, t) {
  ...
  function o(s, a) {
    if (!(s !== null && typeof s == "object"))
      return s;
    if (Array.isArray(s))
      return s.map((f) => o(f, a)).filter(Boolean);
    let D = {}, l = new Set(u(s));
    for (let f in s)
      !Object.prototype.hasOwnProperty.call(s, f) || i.has(f) || (l.has(f) ? D[f] = o(s[f], s) : D[f] = s[f]);
    let p = r(s, D, a);
    if (p !== null)
      return p ?? D;
  }
...
function Zn(e, t, r) {
  ...
  if (Pi(t)) {
    ...
    ({ startNode: p, endNode: f } = Ri(D, l, t));
...
async function uu(e, t, r = 0) {
  ...
  if (t.cursorOffset >= 0) {
    ...
    if ((t.cursorNode || t.nodeBeforeCursor || t.nodeAfterCursor) && o.cursorNodeText)
      ...
      a = 0, D = u, l = 0, p = o.formatted;
    let f = t.cursorOffset - a;
    if (D === p)
      return { formatted: o.formatted, cursorOffset: l + f, comments: s };
    let d = D.split("");
    d.splice(f, 0, eu);
...
//# sourceMappingURL=prettier_standalone.js.map
